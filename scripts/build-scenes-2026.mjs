...
const scenes = {
      ...
      moments: [
        {
          ...
          score: [1, 1],
          situation:
            '90+2분. 고든에게 55분 선제골을 내주고 끌려가다 85분 엔소 페르난데스의 중거리포로 겨우 따라잡았다. 81분에 탈리아피코를 빼고 라우타로를 넣은 총공격 — 오른쪽 끝에서 메시가 스펜스를 마주 본다.',
          objective: '메시로 스펜스를 벗겨내고 뒷문의 라우타로에게 배달하라',
          ball: 'arg_10',
          ...
          easterEgg: {
            ...
            title: '그날, 진짜로 있었던 일',
            caption:
              '2026년 7월 15일 애틀랜타. 메시가 제드 스펜스를 스치듯 제치고 픽퍼드의 머리 너머 뒷문으로 크로스를 보냈고, 아무도 붙지 않은 라우타로 마르티네스가 빈 골문에 머리를 댔다. 90+2분, 잉글랜드의 결승행이 끝났다.',
            images: [],
          },
        },
      ],
      ...
      moments: [
        {
          ...
          score: [0, 0],
          situation:
            '연장 후반 106분, 0-0. 정규시간 추가시간에 엔소 페르난데스가 쿠바르시에게 무리한 태클로 퇴장당해 아르헨티나는 10명이다. 62분에 들어온 페란 토레스가 박스 중앙에 있고, 포로의 크로스가 뒷문의 니코 윌리엄스에게 떨어졌다.',
          objective: '니코 윌리엄스의 머리로 페란 토레스에게 떨궈라',
          ball: 'esp_17',
  ...
  review: {
    ...
    unverified: [
      ...
      'KOR-CZE / KOR-MEX / KOR-RSA: 선발·교체 시각과 등번호는 ESPN 라인업으로 확인했으나, 득점 장면의 정확한 좌표(크로스 지점·헤더 위치)는 미확인이다.',
