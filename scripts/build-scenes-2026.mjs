...
const scenes = {
  ...
  review: {
    ...
    confirmed: [
      ...
      'ENG-ARG: 메시를 (114, 74.7)에서 (110.5, 73)으로 내렸다 — 시작부터 온사이드가 되도록 의도한 조정이다(라인 x=110.5, 여유 1.4m). ' +
        '받은 프레임의 원좌표는 오프사이드 위치였고(원본 메시 99.72 > 잉글랜드 2번째 97.94) 그때는 "오프볼 런으로 내려 받는 것"이 이 장면의 퍼즐이었으나, ' +
        '시작하자마자 깃발이 오르는 편이 장면을 여는 방식으로 나빠 좌표 쪽을 바꿨다.',
