...
//
// 데이터 출처가 둘이지만 모양은 같다 —
//   scenarios.json    : 손으로 쓴 2022 카타르 장면 (경기 하나가 곧 파일 하나)
//   scenes-2026.json  : scripts/build-scenes-2026.mjs가 CSV에서 생성 ({ matches: [...] })
// 새 2026 경기를 추가할 땐 CSV를 고치고 그 스크립트를 다시 돌리면 여기 자동으로 들어온다.
...
// 순서 = 경기 선택 화면의 카드 순서
// 손으로 쓴 과거 명경기(2002·2022)를 앞에, CSV 생성 2026 경기를 뒤에.
// 2018 독일전(kor_ger_2018)은 데이터는 남겨두되 선택창에서만 숨긴다 —
// 다시 노출하려면 위 import와 이 배열에 korGer2018을 되돌리면 된다.
export const MATCHES = [korPor, korIta2002, ...scenes2026.matches]
