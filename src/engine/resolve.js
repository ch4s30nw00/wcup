...
export function calcShot(action, opponents, prev = null) {
  ...
  if (oneOnOne) {
    ...
    // User-set rule: a genuine, unobstructed 1v1 is at least a 40% chance
    // even for a player with finishing=1. The floor is scoped to this exact
    // situation; blocked shots and ordinary shots keep their normal model.
